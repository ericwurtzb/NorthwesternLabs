...
namespace NorthwesternLabs.Areas.Employees.Controllers
{
    public class TestsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TestID1,TestType,RerunDateTime,MaterialID,DateTimeScheduled,DateTimeCompleted")] Test test)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TestID1,TestType,RerunDateTime,MaterialID,DateTimeScheduled,DateTimeCompleted")] Test test)
        {
            if (ModelState.IsValid)
            {
